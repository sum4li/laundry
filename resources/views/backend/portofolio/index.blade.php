...
@section('title',title_case(App\Menu::find($menu_id)->name))
@section('content')
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-bordered" id="portofolio-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nama</th>
...
$(document).ready(function () {
    ...
    var $table = $('#portofolio-table').DataTable({
         processing: true,
         serverSide: true,
         responsive: true,
         stateSave: true,
         dom: '<"toolbar">rtp',
         ajax: '{!! route('portofolio.source',$menu_id) !!}',
         columns: [
      ...
      $('#portofolio-table_wrapper > div.toolbar').html('<div class="row">' +
                '<div class="col-lg-10">'+
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                    '<a href="{{ route("portofolio.create",$menu_id) }}" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
                '</div>' +
                '</div>');
    ...
    $('#portofolio-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
