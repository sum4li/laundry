...
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-bordered table-striped" id="article-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Judul</th>
...
$(document).ready(function () {
    ...
    var $table = $('#article-table').DataTable({
         ...
         stateSave: true,
         dom: '<"toolbar">rtp',
         ajax: '{!! route('article.source',$menu_id) !!}',
         columns: [
      ...
      $('#article-table_wrapper > div.toolbar').html('<div class="row">' +
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                    '<a href="{{ route("article.create",$menu_id) }}" class="btn btn-primary float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
                '</div>' +
                '</div>');
    ...
    $('#article-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
