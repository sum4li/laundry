            ...
            <form action="{{route('service.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label>Icon</label>
                            <input type="text" name="icon" id="icon-picker" class="form-control border-dark-50" required="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                          <label>Deskripsi</label>
                            <textarea name="description" class="form-control border-dark-50" required></textarea>
                        </div>
                    </div>
                </div>
