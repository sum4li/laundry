...
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-bordered" id="promo-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Gambar</th>
...
$(document).ready(function () {
    ...
    var $table = $('#promo-table').DataTable({
         ...
         stateSave: true,
         dom: '<"toolbar">rtp',
         ajax: '{!! route('promo.source',$menu_id) !!}',
         columns: [
      ...
      $('#promo-table_wrapper > div.toolbar').html('<div class="row">' +
                ...
                '</div>'+
                '<div class="col-lg-2">'+
                    '<a href="{{ route("promo.create",$menu_id) }}" class="btn btn-sm btn-primary float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
                '</div>' +
                '</div>');
    ...
    $('#promo-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
